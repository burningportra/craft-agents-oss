...
export type NavigatorType = 'sessions' | 'sources' | 'skills' | 'settings' | 'tasks'
...
const COMPOUND_ROUTE_PREFIXES = [
  'allSessions', 'flagged', 'archived', 'state', 'label', 'view', 'sources', 'skills', 'settings', 'tasks'
]
